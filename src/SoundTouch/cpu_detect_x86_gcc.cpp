...
//
// $Id: cpu_detect_x86_gcc.cpp,v 1.2 2008/10/02 02:51:04 jeff Exp $
//
////////////////////////////////////////////////////////////////////////////////
//
// License :
...
{
	// jsl - having trouble running this twice on Mac, auval would always crash after
	// deleting the plugin then creating another one, not sure what the deal is but
	// since I always ended up using the plain C versions anyway just ignore this
#ifdef OSX
	return 0;
#endif
