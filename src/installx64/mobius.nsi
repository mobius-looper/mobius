...
InstallDir "$PROGRAMFILES64\Mobius 2"
  
;Get installation folder from registry if available
InstallDirRegKey HKCU "Software\Circular Labs\Mobius 2 x64" ""
...
Section "Core Section" SecCore
  ...
  IfFileExists "$PROGRAMFILES64\VstPlugins" VstPluginsExists DoneWithFiles

  VstPluginsExists:
  SetOutPath "$PROGRAMFILES64\VstPlugins"
  File ..\mobius\MobiusVst2.dll 
  ...
  WriteRegStr HKCU "Software\Circular Labs\Mobius 2 x64" "InstDirectory" $INSTDIR
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Circular Labs\Mobius 2 x64"
